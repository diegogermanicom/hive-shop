    ...
    <body id="<?= $data['admin']['name_page']; ?>">
        <div class="app">
            ...
            <div id="container-admin">
                <section>
                    <div class="container">
                        <div class="title-container underline text-left">New payment method</div>
                    </div>
                    <div class="container-xl" id="form-new-payment">
                        <div class="row pb-20">
                        ...
                        <div class="custom-tab pb-20" id="languages">
                            ...
                            ?><div id-tab="<?= ($index + 1); ?>"<?= $active; ?>>
                                    <div class="pb-10"><b>Payment name *</b></div>
                                    <div class="pb-20">
                        ...
                        <div class="text-center pt-40">
                            <div id="btn-save-new-payment" class="btn btn-black">Create Payment</div>
                        </div>
                    </div>
                </section>
