    ...
    <body id="<?= $data['admin']['name_page']; ?>">
        <div class="app">
            ...
            <div id="container-admin">
                <section>
                    <div class="container content-new-category">
                        <div class="title-container underline text-left">Create new category</div>
                        <div class="row pb-20">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 pr-10 pr-sm-0">
                                <div class="pb-10"><b>Category properties</b></div>
                        ...
                        <div class="text-center pt-40">
                            <div id="btn-save-new-category" class="btn btn-black">Create Category</div>
                        </div>
                    </div>
                </section>
