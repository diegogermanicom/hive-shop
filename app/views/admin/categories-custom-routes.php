    ...
    <body id="<?= $data['admin']['name_page']; ?>">
        <div class="app">
                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 pr-5 pr-sm-5">
                            <div id="btn-save-new-category-custom-route" class="btn btn-black w-100">Create route</div>
                        </div>
            ...
            <div id="container-admin">
                <section>
                    <div class="container">
                        <div class="title-container underline text-left">Categories custom routes</div>
                        <div class="pb-20">
                            <div id="open-popup-new-category-custom-route" class="btn btn-black">Create new route</div>
                        </div>
                        <div id="categories-custom-routes-content"><?= $data['routes']['html']; ?></div>
