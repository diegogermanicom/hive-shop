    ...
    <body id="<?= $data['admin']['name_page']; ?>">
        <div class="app">
            ...
            <div id="container-admin">
                <section>
                    <div class="container">
                        <div class="title-container underline text-left">New tax zone</div>
                    </div>
                    <div class="container-xl" id="form-new-tax-zone">
                        <div class="row pb-20">
                        ...
                        <div class="text-center pt-40">
                            <div id="btn-save-new-tax-zone" class="btn btn-black">Create tax zone</div>
                        </div>
                    </div>
                </section>
