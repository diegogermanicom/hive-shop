    ...
    <body id="<?= $data['admin']['name_page']; ?>">
        <div class="app">
            ...
            <div id="container-admin">
                <section>
                    <div class="container">
                        <div class="title-container underline text-left">Edit tax zone</div>
                    </div>
                    <div class="container-xl" id="form-edit-tax-zone">
                        <input type="hidden" id="input-id-tax-zone" value="<?= $data['tax_zone']['id_tax_zone']; ?>">
                        <div class="row pb-20">
                            <div class="col-12 col-sm-9 pr-10 pr-sm-0">
                                <div class="pb-10"><b>Tax zone name *</b></div>
                                <div>
                                    <input type="text" id="input-name" class="w-100" validate validate-type="name" value="<?= $data['tax_zone']['name']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="custom-tab">
                                ...
                                <div class="content">
                                    <div id-tab="1" class="active">
                                        ...
                                        <div id="tax-zone-continents"><?= $data['continents']; ?></div>
                                    </div>
                                    <div id-tab="2">
                                        <div class="row pb-20">
                                        ...
                                        <div id="tax-zone-countries"></div>
                                        <div id="tax-zone-countries-pager" class="pager text-center pt-20"></div>
                                    </div>
                                    <div id-tab="3">
                                        <div class="row pb-20">
                                            <div class="col-12 col-sm-6 pt-10">
                                        ...
                                        <div id="tax-zone-provinces"></div>
                                        <div id="tax-zone-provinces-pager" class="pager text-center pt-20"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-center pt-40">
                            <div id="btn-delete-tax-zone" class="btn btn-red">Delete</div>
                            <div id="btn-save-edit-tax-zone" class="btn btn-black">Save tax zone</div>
                        </div>
                    </div>
                </section>
