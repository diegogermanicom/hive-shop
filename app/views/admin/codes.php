    ...
    <body id="<?= $data['admin']['name_page']; ?>">
        <div class="app">
            ...
            <div id="container-admin">
                <section>
                    <div class="container">
                        <div class="title-container underline text-left">Code list</div>
                        <div class="pb-20">
                            <a href="<?= ADMIN_PATH; ?>/new-code" class="btn btn-black">Create new code</a>
                        </div>
                        <div><?= $data['codes']['html']; ?></div>
                        <div class="pager text-center pt-20"><?= $data['codes']['pager']; ?></div>
                    </div>
                </section>
